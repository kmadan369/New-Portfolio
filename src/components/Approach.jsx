    ...
    <section id="workflow" className="w-full py-20">
      ...
      <div className="my-20 flex flex-col items-center justify-center gap-4 lg:flex-row">
        <Card
          ...
          description="Analyze business goals, user needs, market context, and technical constraints to clearly define the problem, align stakeholders, and establish measurable success criteria before moving into design solutions."
        >
          <CanvasRevealEffect
            animationSpeed={5.1}
        ...
        <Card
          ...
          description="Translate requirements into intuitive user flows, wireframes, and high-fidelity interfaces, then create interactive prototypes to validate usability, functionality, and user experience before development."
        >
          <CanvasRevealEffect
            animationSpeed={3}
...
const Card = ({ title, description, icon, children }) => {
  ...
  return (
    <div
      ...
      className="group/canvas-card relative mx-auto flex w-full max-w-sm items-center justify-center rounded-3xl border border-white/[0.2] p-4 lg:h-[35rem]"
    >
      ...
      <div className="relative z-20 flex w-full flex-col items-center justify-center text-center">
        ...
        <h2 className="relative z-10 mt-4 text-3xl font-bold text-white opacity-0 transition duration-200 group-hover/canvas-card:-translate-y-2 group-hover/canvas-card:opacity-100">
          {title}
        </h2>

        <p className="relative z-10 mt-4 text-sm font-medium text-[#e4ecff] opacity-0 transition duration-200 group-hover/canvas-card:-translate-y-2 group-hover/canvas-card:opacity-100">
          {description}
        </p>
      </div>
    </div>
